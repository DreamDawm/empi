...
CREATE TABLE IF NOT EXISTS empi_master (
    ...
    pinyin_gender_index VARCHAR(100) NULL COMMENT '姓名拼音+性别预索引',
    birth_year_gender_index VARCHAR(50) NULL COMMENT '出生年份+性别预索引',
    id_card_prefix_index VARCHAR(20) NULL COMMENT '身份证前6位预索引',
    ...
    KEY idx_pinyin_gender (pinyin_gender_index),
    KEY idx_birth_year_gender (birth_year_gender_index),
    KEY idx_id_card_prefix (id_card_prefix_index)
